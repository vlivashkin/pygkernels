...
class TestTable1(ABC):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.etalon = {  # SCT CCT FE RSP SP Com For Heat Walk lCom lFor lHeat lWalk LVN
            ...
            "lfr1": (0.976, 0.990, 0.981, 0.983, 0.890, 0.052, 0.027, 0.051, 0.003, 0.475, 0.500, 0.511, 0.485, 0.962),
            "lfr2": (1.000, 1.000, 1.000, 1.000, 0.986, 0.147, 0.164, 0.266, 0.694, 0.481, 0.478, 0.449, 0.682, 0.823),
            "lfr3": (1.000, 0.997, 1.000, 1.000, 0.989, 0.087, 0.130, 0.159, 0.502, 0.520, 0.379, 0.376, 0.729, 0.827),
            "news_2cl1": (
                0.608,
                0.638,
                0.584,
