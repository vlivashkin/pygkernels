...
\begin{figure}[H]
	\includegraphics[width=.7\linewidth]{pictures/pg-vs-sklearn_pout01_averaging200.png}
	\caption{\label{f_vs2} Ours vs Sklearn $p_{out}=0.1$ averaging 200}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=.7\linewidth]{pictures/pg-vs-sklearn_pout01_averaging500.png}
...
\begin{figure}[H]
	\includegraphics[width=.7\linewidth]{pictures/pg-vs-rubanov_pgward_pout01_averaging200.png}
	\caption{\label{f_vs2} Ours vs Rubanov, ours Ward, $p_{out}=0.1$ averaging 200}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=.7\linewidth]{pictures/pg-vs-rubanov_pgward_pout01_averaging200_2.png}
	\caption{\label{f_vs2} Ours vs Rubanov, ours Ward, $p_{out}=0.1$ averaging 200}
\end{figure}
